  ...
  return <div className={`app ${theme}`}>
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        ...
        <button type="button" className="language-button" onClick={() => setLanguage(albanian ? 'en' : 'sq')} aria-label={albanian ? 'Kalo në anglisht' : 'Switch to Albanian'} title={albanian ? 'Kalo në anglisht' : 'Switch to Albanian'}><span className={!albanian ? 'active' : ''}>EN</span><i>⇄</i><span className={albanian ? 'active' : ''}>SQ</span></button>
    ...
    <button type="button" className="mobile-language-button" onClick={() => setLanguage(albanian ? 'en' : 'sq')} aria-label={albanian ? 'Kalo në anglisht' : 'Switch to Albanian'}>{albanian ? 'EN' : 'SQ'} <span>⇄</span></button>
    <main>{children}</main>
  </div>
}
